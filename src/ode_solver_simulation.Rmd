...
out3 <- out3 %>% as.data.frame() %>% 
  ...
  mutate(catch_s3 = q_s * N_s3^beta_s3 * E3,
         ...
         cpue_w3 = catch_w3 / E3,
         cost3 = cost * E3,
         pi_st3 = catch_s3 *price_s3 - (catch_s3 * cost3),
         pi_w3 = catch_w3 * price_w3 - (catch_w3 * cost3)) %>% 
...
out4 <- out4 %>% 
  ...
  mutate(catch_s4 = q_s * N_s4^beta_s4 * E4,
         ...
         cpue_w4 = catch_w4 / E4,
         cost4 = cost * E4,
         pi_st4 = catch_s4 * price_s4 - (catch_s4 * cost4),
         pi_w4 = catch_w4 * price_w4 - (catch_w4 * cost4)) %>% 
...
# 
# # Define the initial state and parameters
# state5 <- c(N_s5 = 100, N_w5 = 50, E5 = 0.5) #, C_s1 = 0, C_w1 = 0, Pi_s1 = 0, Pi_w1 = 0
# parameters_5 <- c(q_s = 0.02, q_w = 0.02, k_s = 100, k_w = 50, r_s = 1, r_w = 0.99, alpha = 1,
