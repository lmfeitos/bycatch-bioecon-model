...
run_model_ps_fcn <- function(r_s, k_s, q_s, p_s, r_w, k_w, q_w, p_w, c, f_s, beta_s, A_s){
...
#write_csv(output_join_test_w, file = file.path(outdir, "output_w_fcn2.csv"), col_names = T)
```
