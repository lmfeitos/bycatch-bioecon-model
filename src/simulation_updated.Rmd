...
beta_w <- scenarios_df_msy1$beta_w[1]
A_w <- scenarios_df_msy1$A_w[1]
...
for(i in 1:nrow(scenarios_df_msy1)){
  ...
  beta_w <- scenarios_df_msy1$beta_w[i]
  A_w <- scenarios_df_msy1$A_w[i]
...
beta_w <- scenarios_df_msy2$beta_w[1]
A_w <- scenarios_df_msy2$A_w[1]
...
for(i in 1:nrow(scenarios_df_msy2)){
  ...
  beta_w <- scenarios_df_msy2$beta_w[i]
  A_w <- scenarios_df_msy2$A_w[i]
...
for(i in 1:nrow(scenarios_df_subs1)){
  ...
  if(i == 1){
    output_sub <- output_subs1
  }
  else{
    output_sub <- rbind(output_sub, output_subs1)
  }

}

output_join <- output_sub %>% 
  rename(scenario_id = sc_id) %>% 
...
for(i in 1:nrow(scenarios_df_subs2)){
  ...
  if(i == 1){
    output_sub <- output_subs2
  }
  else{
    output_sub <- rbind(output_sub, output_subs2)
  }
