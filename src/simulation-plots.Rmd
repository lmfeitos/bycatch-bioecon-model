...
plot_1_gather_test <- 
 ...
 ggsave(file.path(outdir, "plot_1.png"), plot = plot_1_gather_test,
       width = 12, height = 8, bg = "white", dpi = 300)
 
  # ggsave(file.path(outdir, "pub_ready", "figure_1.pdf"), plot = plot_1_gather_test,
...
# Create facet labels
sub1_label1 <- c("Weak stock price = 1")
...
```{r, echo = FALSE, include = FALSE}
sub1_label2 <- c("Weak stock price = 0")
...
sub_plot_final <- 
 ...
 ggsave(file.path(outdir, "sub_plot_25pct.png"), plot = sub_plot_final,
      width = 12, height = 8, bg = "white", dpi = 300)
 
  ggsave(file.path(outdir, "pub_ready", "figure_2.pdf"), plot = sub_plot_final,
      width = 12, height = 8, bg = "white", dpi = 600)
```
