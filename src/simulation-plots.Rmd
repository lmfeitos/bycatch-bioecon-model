...
lines(x = tset, y = E_simu1,
      type = "l", col = "green")
lines(x = tset, y = N_w_test_1,
      type = "l", col = "red")
lines(x = tset, y = N_s_test_1,
      type = "l", col = "red3")
lines(x = tset, y = E_test1,
      type = "l", col = "red4")
title(main = "First simulation - Both stocks with the same price",
      sub = "Params: q_s = 0.1, q_w = 0.1, r_s = 0.75, r_w = 0.25, k_s = 4, k_w = 2, p_s = 1, p_w = 1")
legend(x = 300, y = 10,
       lwd = 2,
       legend = c("Ns", "Nw", "E", "Nwt", "Nst", "Et"),
       col = c("blue", "orange", "green", "red", "red3", "red4"))
```
...
title(main = "Second simulation - Price ratio = 0.2",
      sub = "Params: q_s = 0.1, q_w = 0.1, r_s = 0.75, r_w = 0.25, k_s = 4, k_w = 2, p_s = 2.5, p_w = 1")
legend(x = 80, y = 7.7,
       lwd = 2,
       legend = c("Ns", "Nw", "E"),
...
title(main = "Third simulation - Price ratio = 0.1",
      sub = "Params: q_s = 0.1, q_w = 0.1, r_s = 0.75, r_w = 0.25, k_s = 4, k_w = 2, p_s = 10, p_w = 2")
legend(x = 80, y = 14,
       lwd = 2,
       legend = c("Ns", "Nw", "E"),
       col = c("blue", "orange", "green"))
...
title(main = "Fourth simulation - Price ratio = 0.01",
      sub = "Params: q_s = 0.1, q_w = 0.1, r_s = 0.75, r_w = 0.25, k_s = 4, k_w = 2, p_s = 0.1, p_w = 10")
legend(x = 80, y = 10,
       lwd = 2,
       legend = c("Ns", "Nw", "E"),
       col = c("blue", "orange", "green"))
...
title(main = "Fifth simulation - Price ratio = 2",
      sub = "Params: q_s = 0.1, q_w = 0.1, r_s = 0.75, r_w = 0.25, k_s = 4, k_w = 2, p_s = 5, p_w = 2.5")
legend(x = 80, y = 25,
       lwd = 2,
       legend = c("Ns", "Nw", "E"),
       col = c("blue", "orange", "green"))
...
title(main = "Seventh simulation - Price ratio = 100",
      sub = "Params: q_s = 0.1, q_w = 0.1, r_s = 0.75, r_w = 0.25, k_s = 4, k_w = 2, p_s = 10, p_w = 1")
legend(x = 80, y = 40,
       lwd = 2,
       legend = c("Ns", "Nw", "E"),
       col = c("blue", "orange", "green"))
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s8 <- (N_s8 * (r_s8 * (1 - (N_s8/k_s8)) - q_s8 * E8)) * dt
  dN_w8 <- (N_w8 * (r_w8 * (1 - (N_w8/k_w8)) - q_w8 * E8)) * dt
  dN_st8 <- (N_st8 * (r_s8 * (1 - (N_st8/k_s8)) - q_s8 * E_t8)) * dt
  dN_wt8 <- (N_wt8 * (r_w8 * (1 - (N_wt8/k_w8)) - q_w8 * E_t8)) * dt
  dE8 <- (alpha * E8 * (p_s8 * q_s8 * N_s8 + p_w8 * q_w8 * N_w8 - c)) * dt
...
sc_1 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = 1, p_w = 0.1, c = 0.05)
sc_2 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = 1, p_w = 0.2, c = 0.05)
sc_3 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = 1, p_w = 0.4, c = 0.05)
sc_4 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = 1, p_w = 1, c = 0.05)
sc_5 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = 0.75, p_w = 1, c = 0.05)
sc_6 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = 0.5, p_w = 1, c = 0.05)
sc_7 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = 0.2, p_w = 1, c = 0.05)
sc_8 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = .1, p_w = 1, c = 0.05)
...
eq_par <- data.frame(parameter = c("q_w", "q_s", "k_w", "k_s", "r_w", "r_s", "p_w", "p_s", "c"),
                     "PR_10" = c(0.1, 0.1, 4, 2, 0.75, 0.25, 1, 0.1, 0.05),
                     "PR_5" = c(0.1, 0.1, 4, 2, 0.75, 0.25, 1, 0.2, 0.05),
                     "PR_2.5" = c(0.1, 0.1, 4, 2, 0.75, 0.25, 1, 0.4, 0.05),
                     "PR_1" = c(0.1, 0.1, 4, 2, 0.75, 0.25, 1, 1, 0.05),
                     "PR_0.75" = c(0.1, 0.1, 4, 2, 0.75, 0.25, 0.75, 1, 0.05),
                     "PR_0.5" = c(0.1, 0.1, 4, 2, 0.75, 0.25, 0.5, 1, 0.05),
                     "PR_0.25" = c(0.1, 0.1, 4, 2, 0.75, 0.25, 0.25, 1, 0.05),
                     "PR_0.1" = c(0.1, 0.1, 4, 2, 0.75, 0.25, 0.1, 1, 0.05))
...
var_full <- bind_rows(effort_df, effort_test_df, nw_df, ns_df, ns_t_df, nw_t_df, catch_s_df, catch_w_df, cpue_s_df, cpue_w_df, profits_df, profits_w_df, profits_s_df)
...
Panel A shows the time series dynamics for the strong and weak stocks, and effort. Panel B plots a different effort equation ($$\frac{dE}{dt} = (p_s  q_s  N_S + p_w q_w N_W) - c$$). Panel C shows the same data but without effort for better comparison. Panel C shows the CPUE and catch for the strong and weak stocks separately. Panel D shows the profits for the strong and weak stocks, and the total profits for the fishery through time.
