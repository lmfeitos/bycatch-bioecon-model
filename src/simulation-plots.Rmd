...
output_growth_ranges %>% 
  ...
  ggplot() +  
  geom_raster(aes(x = r_w, y = r_s, fill = values/2)) +
...
weak_stock_test <- 
  ...
  scale_fill_paletteer_c("viridis::plasma",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.6)) +
  scale_x_continuous(breaks = seq(0.87, 1, 0.02),
                     expand = c(0,0)) +
  scale_y_continuous(breaks = seq(0, 10, 1),
                     expand = c(0,0)) +
  labs(x = "Growth rate ratio (rw/rs)",
       ...
       fill = "B/K",
       title = "Weak stock heatmap full data") +
  theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        panel.grid.minor.y = element_blank(),
...
weak_stock_test_pos <- 
  ...
  labs(x = "Growth rate ratio (rw/rs)",
       y = "Strong stock price",
       fill = "B/K",
       title = "Weak stock heatmap with 0 >= B/K >= 1") +
  theme_bw() +
...
weak_stock_test + weak_stock_test_pos
```
...
output_weak_test %>%
  ggplot() +
  geom_line(aes(x = p_w_star, y = N_w_star, color = b_v_k),
            size = 1) +
  scale_color_paletteer_c("viridis::plasma") +
