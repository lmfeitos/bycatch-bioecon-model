...
```{r distribution of negative values for Ns and Nw for the range of qs, echo = FALSE, include = FALSE}
...
```{r, echo = FALSE, fig.height=12, fig.width=12, include= FALSE}
# (q_ranges + r_ranges) /
#   (rw_vs_qs + rw_vs_qw) /
...
```{r distribution of negative values for Ns and Nw for the range of rs, echo = FALSE, include= FALSE}
...
```{r plot first scenario of fishery subsidies where the strong stock price increases and weak stock price remains constabt, echo = FALSE}
# Create facet labels
sub1_label1 <- c("10%")
names(sub1_label1) <- c("0.045")

sub1_label2 <- c("30%")
names(sub1_label2) <- c("0.035")

sub1_label3 <- c("50%")
names(sub1_label3) <- c("0.025")

sub1_label4 <- c("70%")
names(sub1_label4) <- c("0.015")

sub1_label5 <- c("90%")
names(sub1_label5) <- c("0.005")
...
subs1_s_proc_plot2 <-
  ggplot(data = output_subs1_proc %>% 
           filter(p_w == 1 & c == 0.035 & st_stock_rev <= 20)) + 
...
subs1_s_proc_plot4 <-
  ggplot(data = output_subs1_proc %>% 
           filter(p_w == 1 & c == 0.015 & st_stock_rev <= 20)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(st_stock_rev, 8), fill = log_b_v_k_w, height = 2.7, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
  ...
  facet_wrap(~ c,
             nrow = 1,
             scales = "free_y",
             labeller = labeller(c = sub1_label4)) +
  scale_x_continuous(breaks = seq(1, 10, 3),
                     expand = c(0,0)) +
  scale_y_continuous(expand = c(0,0)) +
  labs(x = "",
...
subs1_s_proc_plot5 <-
  ggplot(data = output_subs1_proc %>% 
           filter(p_w == 1 & c == 0.005 & st_stock_rev <= 20)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(st_stock_rev, 8), fill = log_b_v_k_w, height = 8, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
  ...
  facet_wrap(~ c,
             nrow = 1,
             scales = "free_y",
             labeller = labeller(c = sub1_label5)) +
  scale_x_continuous(breaks = seq(1, 10, 3),
                     expand = c(0,0)) +
  scale_y_continuous(expand = c(0,0)) +
  labs(x = "",
...
subs1_s_proc_plot2.1 <-
  ggplot(data = output_subs1_proc %>% 
           filter(p_w == 1 & c == 0.035 & st_stock_rev <= 12 & vuln_ratio_w <= 4)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(st_stock_rev, 8), fill = log_b_v_k_w, height = 1.2, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
                         breaks = seq(0, 0.3, 0.1)) +
...
subs1_s_proc_plot4.1 <-
  ggplot(data = output_subs1_proc %>% 
           filter(p_w == 1 & c == 0.015 & st_stock_rev <= 12 & vuln_ratio_w <= 4)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(st_stock_rev, 8), fill = log_b_v_k_w, height = 2.7, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
                         breaks = seq(0, 0.15, 0.03)) +
...
subs1_s_proc_plot5.1 <-
  ggplot(data = output_subs1_proc %>% 
           filter(p_w == 1 & c == 0.005 & st_stock_rev <= 20 & vuln_ratio_w <= 4)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(st_stock_rev, 8), fill = log_b_v_k_w, height = 8, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
                         breaks = seq(0, 0.05, 0.01)) +
...
subs2_s_proc_plot2.1 <-
  ggplot(data = output_subs1_proc %>% 
           filter(p_w < 1 & c == 0.035 & vuln_ratio_w <= 4 & st_stock_rev <= 12)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(st_stock_rev, 8), fill = log_b_v_k_w, height = 1.2, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
                         breaks = seq(0, 0.3, 0.1)) +
...
```{r plot second scenario of fishery subsidies where the weak stock price increases and strong stock price remains constabt, echo = FALSE}
# Create facet labels
sub1_label1 <- c("10%")
names(sub1_label1) <- c("0.045")
...
subs1_w_proc_plot4 <-
  ggplot(data = output_subs2_proc %>% 
           filter(p_s == 1 & c == 0.015)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(w_stock_rev, 8), fill = log_b_v_k_w, height = 2.7, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
                         breaks = seq(0, 0.15, 0.03)) +
  facet_wrap(~ c,
...
subs1_w_proc_plot5 <-
  ggplot(data = output_subs2_proc %>% 
           filter(p_s == 1 & c == 0.005)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(w_stock_rev, 8), fill = log_b_v_k_w, height = 8, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
                         breaks = seq(0, 0.05, 0.01)) +
  facet_wrap(~ c,
...
subs1_w_proc_plot2.1 <-
  ggplot(data = output_subs2_proc %>% 
           filter(p_s == 1 & c == 0.035  & vuln_ratio_w <= 4)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(w_stock_rev, 8), fill = log_b_v_k_w, height = 1.2, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
                         breaks = seq(0, 0.3, 0.1)) +
...
subs1_w_proc_plot3.1 <-
  ggplot(data = output_subs2_proc %>% 
           filter(p_s == 1 & c == 0.025  & vuln_ratio_w <= 4)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(w_stock_rev, 8), fill = log_b_v_k_w, height = 1.6, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
                         breaks = seq(0, 0.2, 0.05)) +
...
subs1_w_proc_plot4.1 <-
  ggplot(data = output_subs2_proc %>% 
           filter(p_s == 1 & c == 0.015 & vuln_ratio_w <= 4)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(w_stock_rev, 8), fill = log_b_v_k_w, height = 2.7, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
                         breaks = seq(0, 0.15, 0.03)) +
...
subs1_w_proc_plot5.1 <-
  ggplot(data = output_subs2_proc %>% 
           filter(p_s == 1 & c == 0.005 & vuln_ratio_w <= 4)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(w_stock_rev, 8), fill = log_b_v_k_w, height = 8, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
                         breaks = seq(0, 0.05, 0.01)) +
...
subs2_w_proc_plot2.1 <-
  ggplot(data = output_subs2_proc %>% 
           filter(p_s == 2 & c == 0.035 & vuln_ratio_w <= 4)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(w_stock_rev, 8), fill = log_b_v_k_w, height = 1.2, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
                         breaks = seq(0, 0.2, 0.05)) +
...
subs2_w_proc_plot3.1 <-
  ggplot(data = output_subs2_proc %>% 
           filter(p_s == 2 & c == 0.025 & vuln_ratio_w <= 4)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(w_stock_rev, 8), fill = log_b_v_k_w, height = 1.6, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
                         breaks = seq(0, 0.1, 0.025)) +
...
subs2_w_proc_plot4.1 <-
  ggplot(data = output_subs2_proc %>% 
           filter(p_s == 2 & c == 0.015 & vuln_ratio_w <= 4)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(w_stock_rev, 8), fill = log_b_v_k_w, height = 2.7, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
                         breaks = seq(0, 0.1, 0.02)) +
...
subs2_w_proc_plot5.1 <-
  ggplot(data = output_subs2_proc %>% 
           filter(p_s == 2 & c == 0.005 & vuln_ratio_w <= 4)) + 
  geom_tile(aes(x = round(vuln_ratio_w, 8), y = round(w_stock_rev, 8), fill = log_b_v_k_w, height = 8, width = .1)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.1),
                         breaks = seq(0, 0.1, 0.01)) +
...
```{r, echo = FALSE}
# w_fcn_s_rev_plot <-
#   ggplot(data = output_fcn_test_pw_proc) +
#   geom_tile(aes(x = log1p(vuln_ratio_w), y = st_stock_rev, fill = b_v_k_w2, width = 1)) +
#   scale_fill_paletteer_c("viridis::viridis",
#                           rescaler = ~ scales::rescale_mid(.x, mid = 0.5),
#                          breaks = seq(0, 1, 0.2)) +
#   scale_x_continuous(expand = c(0,0)) +
...
# w_fcn_w_rev_plot <-
#   ggplot(data = output_fcn_test_pw_proc) +
#   geom_tile(aes(x = log1p(vuln_ratio_w), y = w_stock_rev, fill = b_v_k_w2, width = 1)) +
#   scale_fill_paletteer_c("viridis::viridis",
#                           rescaler = ~ scales::rescale_mid(.x, mid = 0.5),
#                          breaks = seq(0, 1, 0.2)) +
#   scale_x_continuous(expand = c(0,0)) +
...
```{r, echo = FALSE}
# s_fcn_s_rev_plot <-
#   ggplot(data = output_fcn_test_ps_proc) +
#   geom_tile(aes(x = log1p(vuln_ratio_w), y = st_stock_rev, fill = b_v_k_w2, width = 1)) +
#   scale_fill_paletteer_c("viridis::viridis",
#                           rescaler = ~ scales::rescale_mid(.x, mid = 0.5),
#                          breaks = seq(0, 1, 0.2)) +
...
for(i in 2:length(tset)) {
  ...
  # if the time before N_w goes negative, run N_w as usual. Else, continue populating the vector with zeros.
 #   if(N_w_simu1 >= 0){
 #       N_w_simu1 <- N_w_simu1
 # } else {
 #       N_w_simu1 <- 0
 ...
 #       E_simu1 <- E_simu1
 # } else {
 #       E_simu1 <- ((alpha * E1 * (A_s * (q_s * N_s1^beta_s1 * E1)^-f_s1 * q_s * N_s1^beta_s1 + A_w * (q_w * N_w1^beta_w1 * E1)^-f_w1 * q_w * N_w1^beta_w1) - c) * dt)
 #       
 # }
  # if(N_w_simu1 >= 9.155209e-09){
  #   
  #   N_w_simu1 = N_w_simu1
  # 
  # } else { 
  ...
  # }
    ...
    #if(tset[i] < 40.43404){ N_s_simu1 <- N_s_simu1} else {N_s_simu1 <- (N_s1 * r_s * (1 - (N_s1/k_s)) - q_s * N_s1^beta_s1 * E) * dt}
    #if(tset[i] < 40.43404){ E_simu1 <- E_simu1} else {E_simu1 <- (alpha * E * (A_s * (q_s * N_s1^beta_s1 * E)^-f_s1 * q_s * N_s1^beta_s1) - c) * dt}
    #if(tset[i] < 40.43404){ Pi_sum_simu1 <- Pi_sum_simu1} else {Pi_sum_simu1 <- Pi_s_simu1}
...
for(i in 2:length(tset)) {
  ...
  # 
  # if(N_w_simu2 <= 0){
  #   E_simu2 <- (alpha * E2 * (A_s * (q_s * N_s2^beta_s2 * E2)^-f_s2 * q_s * N_s2^beta_s2 - (c))) * dt
  # } else {
  #   E_simu2 <- E_simu2
  # }
...
```{r scenario 3, echo = FALSE}
# f_w > beta_w; f_s < b_beta_s
# Weak stock should go extinct but not the strong stock
# set up the parameter space
beta_w3 <- 1
beta_s3 <- 1
f_w3 <- 0.22
...
for(i in 2:length(tset)) {
  ...
  #   E_simu3 <- E_simu3
  # } else {
  #   E_simu3 <- (alpha * E3 * (A_s * (q_s * N_s3^beta_s3 * E3)^-f_s3 * q_s * N_s3^beta_s3 - (c))) * dt
  # }
  # 
  # change in time
  dt <- tset[i] - tset[i-1]
  ...
  # Calculate change in variable size at each time step
  dN_s3 <- (r_s * N_s3 * (1 - (N_s3/k_s)) - (q_s * N_s3^beta_s3 * E3)) * dt
  dN_w3 <- (r_w * N_w3 * (1 - (N_w3/k_w)) - (q_w * N_w3^beta_w3 * E3)) * dt
  dE3 <- (alpha * E3 * (A_s * (q_s * N_s3^beta_s3 * E3)^-f_s3 * q_s * N_s3^beta_s3 +
                        A_w * (q_w * N_w3^beta_w3 * E3)^-f_w3 * q_w * N_w3^beta_w3 - (c))) * dt
  dC_s3 <- (q_s * N_s3^beta_s3 * E3) * dt
  dC_w3 <- (q_w * N_w3^beta_w3 * E3) * dt
  dcpue_s3 <- (C_s3 / E3) * dt
  dcpue_w3 <- (C_w3 / E3) * dt
  dPi_s3 <- (C_s3 * A_s * (q_s * N_s3^beta_s3 * E3)^-f_s3 - C_s3 * c) * dt
  dPi_w3 <- (C_w3 * A_w * (q_w * N_w3^beta_w3 * E3)^-f_w3 - C_w3 * c) * dt
  dPi3 <- (C_s3 * A_s * (q_s * N_s3^beta_s3 * E3)^-f_s3 + C_w3 * A_w * (q_w * N_w3^beta_w3 * E3)^-f_w3 - ((C_s3 + C_w3) * c)) * dt
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s4 <- (r_s * N_s4 * (1 - (N_s4/k_s)) - (q_s * N_s4^beta_s4 * E4)) * dt
  dN_w4 <- (r_w * N_w4 * (1 - (N_w4/k_w)) - (q_w * N_w4^beta_w4 * E4)) * dt
  dE4 <- (alpha * E4 * (A_s * (q_s * N_s4^beta_s4 * E4)^-f_s4 * q_s * N_s4^beta_s4 +
                        A_w * (q_w * N_w4^beta_w4 * E4)^-f_w4 * q_w * N_w4^beta_w4 - (c))) * dt
  dC_s4 <- (q_s * N_s4^beta_s4 * E4) * dt
  dC_w4 <- (q_w * N_w4^beta_w4 * E4) * dt
  dcpue_s4 <- (C_s4 / E4) * dt
  dcpue_w4 <- (C_w4 / E4) * dt
  dPi_s4 <- (C_s4 * A_s * (q_s * N_s4^beta_s4 * E4)^-f_s4 - C_s4 * c) * dt
  dPi_w4 <- (C_w4 * A_w * (q_w * N_w4^beta_w4 * E4)^-f_w4 - C_w4 * c) * dt
  dPi4 <- (C_s4 * A_s * (q_s * N_s4^beta_s4 * E4)^-f_s4 + C_w4 * A_w * (q_w * N_w4^beta_w4 * E4)^-f_w4 - ((C_s4 + C_w4) * c)) * dt
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s6 <- (r_s * N_s6 * (1 - (N_s6/k_s)) - (q_s * N_s6^beta_s6 * E6)) * dt
  dN_w6 <- (r_w * N_w6 * (1 - (N_w6/k_w)) - (q_w * N_w6^beta_w6 * E6)) * dt
  dE6 <- (alpha * E6 * (A_s * (q_s * N_s6^beta_s6 * E6)^-f_s6 * q_s * N_s6^beta_s6 +
                        A_w * (q_w * N_w6^beta_w6 * E6)^-f_w6 * q_w * N_w6^beta_w6 - (c))) * dt
  dC_s6 <- (q_s * N_s6^beta_s6 * E6) * dt
  dC_w6 <- (q_w * N_w6^beta_w6 * E6) * dt
  dcpue_s6 <- (C_s6 / E6) * dt
  dcpue_w6 <- (C_w6 / E6) * dt
  dPi_s6 <- (C_s6 * A_s * (q_s * N_s6^beta_s6 * E6)^-f_s6 - C_s6 * c) * dt
  dPi_w6 <- (C_w6 * A_w * (q_w * N_w6^beta_w6 * E6)^-f_w6 - C_w6 * c) * dt
  dPi6 <- (C_s6 * A_s * (q_s * N_s6^beta_s6 * E6)^-f_s6 + C_w6 * A_w * (q_w * N_w6^beta_w6 * E6)^-f_w6 - ((C_s6 + C_w6) * c)) * dt
...
for(i in 2:length(tset)) {
  ...
  dPi8 <- (C_s8 * A_s * (q_s * N_s8^beta_s8 * E8)^-f_s8 + C_w8 * A_w * (q_w * N_w8^beta_w8 * E8)^-f_w8 - ((C_s8 + C_w8) * c)) * dt
...
var_plot_price <- var_full_price %>%
   mutate(f_w = case_when(
     ...
     str_detect(scenario_id, "3") ~ 0.6,
     str_detect(scenario_id, "4") ~ 0.8,
     str_detect(scenario_id, "5") ~ 0.22,
  ...
  mutate(f_s = case_when(
     ...
     str_detect(scenario_id, "4") ~ 0.7,
     str_detect(scenario_id, "5") ~ 0.3,
   ...
   mutate(beta_w = case_when(
     ...
     str_detect(scenario_id, "4") ~ 0.4,
     str_detect(scenario_id, "5") ~ 0.5,
...
```{r, echo = FALSE, include = FALSE}
# par_pw_ps_fcn <- data.frame(parameter = c("q_w", "q_s", "k_w", "k_s", "r_w", "r_s", "c", "f_w", "f_s", "beta_w", "beta_s", "A"),
#                      "f_ratio = 0.2\n
#                      beta_ratio = 1.25" = c(0.02, 0.02, 4, 2, 1, 0.5, 0.05, 0.1, 0.5, 0.7, 0.56, 1),
#                      "f_ratio = 0.6\n
#                      beta_ratio = 1.25" = c(0.02, 0.02, 4, 2, 1, 0.5, 0.05, 0.3, 0.5, 0.7, 0.56, 1 ),
#                      "f_ratio = 1\n
#                      beta_ratio = 1.25" = c(0.02, 0.02, 4, 2, 1, 0.5, 0.05, 0.5, 0.5, 0.7, 0.56, 1 ),
#                      "f_ratio = 1.4\n
#                      beta_ratio = 1.25" = c(0.02, 0.02, 4, 2, 1, 0.5, 0.05, 0.6, 0.5, 0.7, 0.56, 1 ),
#                      "f_ratio = 0.44\n
#                      beta_ratio = 0.35" = c(0.02, 0.02, 4, 2, 1, 0.5, 0.05, 0.22, 0.5, 0.2, 0.56, 1 ),
#                      "f_ratio = 0.44\n
#                      beta_ratio = 0.71" = c(0.02, 0.02, 4, 2, 1, 0.5, 0.05, 0.22, 0.5, 0.4, 0.56, 1 ),
#                      "f_ratio = 0.44\n
#                      beta_ratio = 1"    = c(0.02, 0.02, 4, 2, 1, 0.5, 0.05, 0.22, 0.5, 0.56, 0.56, 1),
#                      "f_ratio = 0.44\n
#                      beta_ratio = 1.6" =  c(0.02, 0.02, 4, 2, 1, 0.5, 0.05, 0.22, 0.5, 0.9, 0.56, 1))
# 
# par_pw_ps_fcn %>% 
#   gt() %>%
#   tab_header(title = "Parameter space for the run with both species' prices as a function of their catch") %>% 
#   cols_align(align = "center")
```


```{r, echo = FALSE}
#f_labels <- c("f_ratio = 0.2", "f_ratio = 0.6", "f_ratio = 1", "f_ratio = 1.4", "f_ratio = 0.44", "f_ratio = 0.44", "f_ratio = 0.44", "f_ratio = 0.44")
#names(f_labels) <- c("f_w/f_s = 0.2", "f_w/f_s = 0.6", "f_w/f_s = 1", "f_w/f_s = 1.4", "f_w/f_s = 0.44", "f_w/f_s = 0.44", "f_w/f_s = 0.44", "f_w/f_s = 0.44")
#
#beta_labels <- c("beta_ratio = 1.25", "beta_ratio = 1.25", "beta_ratio = 1.25", "beta_ratio = 1.25",
#                "beta_ratio = 0.35", "beta_ratio = 0.71", "beta_ratio = 1", "beta_ratio = 1.6")
#names(beta_labels) <- c("beta_w/beta_s = 1.25", "beta_w/beta_s = 1.25", "beta_w/beta_s = 1.25", "beta_w/beta_s = 1.25",
#                       "beta_w/beta_s = 0.35", "beta_w/beta_s = 0.71", "beta_w/beta_s = 1", "beta_w/beta_s = 1.6")
...
equal_scales_EWS_fcn <-
  ...
  facet_wrap(~ scenario_id,
             nrow = 1) +
  scale_color_manual(values = c("#A50E82FF", "#6A9E1FFF", "#052F61FF")) +
  scale_x_continuous(expand = c(0,0)) +
  labs(x = "Time (x100)",
       y = "Nw, Ns, E",
       color = "") +
...
```{r, fig.height=15, fig.width=12, echo = FALSE, warning=FALSE}
equal_scales_EWS_fcn /
   dif_scales_fcn /
  equal_scales_CPE_fcn /
     equal_scales_pi_fcn +
...
### Weak stock price as a function of catch vs strong stock price constant

```{r scenario pw as a function 1, echo = FALSE}
# set up the parameter space
p_s <- 1
q_s <- 0.02
q_w <- 0.02
...
for(i in 2:length(tset)) {
 ...
 # }
  ...
  # Calculate change in variable size at each time step
  dN_s1 <- (N_s1 * r_s * (1 - (N_s1/k_s)) - q_s * N_s1 * E1) * dt
  dN_w1 <- (N_w1 * r_w * (1 - (N_w1/k_w)) - q_w * N_w1^beta_w1 * E1) * dt
  dE1 <- (alpha * E1 * p_s * q_s * N_s1 + (A_w * (q_w * N_w1^beta_w1 * E1)^-f_w1 * q_w * N_w1^beta_w1) - c) * dt
  dC_s1 <- (q_s * N_s1 * E1) * dt
  dC_w1 <- (q_w * N_w1^beta_w1 * E1) * dt
  dcpue_s1 <- (C_s1 / E1) * dt
  dcpue_w1 <- (C_w1 / E1) * dt
  ...
  dPi_w1 <- (C_w1 * A_w * (q_w * N_w1^beta_w1 * E1)^-f_w1 - C_w1 * c) * dt
  dPi1 <- (C_s1 * p_s + C_w1 * A_w * (q_w * N_w1^beta_w1 * E1)^-f_w1 - ((C_s1 + C_w1) * c)) * dt
...
```{r scenario 2 pw as a function, echo = FALSE}
# set up the parameter space
beta_w2 <- 0.7
f_w2 <- 0.3
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s2 <- (N_s2 * r_s * (1 - (N_s2/k_s)) - q_s * N_s2 * E2) * dt
  dN_w2 <- (N_w2 * r_w * (1 - (N_w2/k_w)) - q_w * N_w2^beta_w2 * E2) * dt
  dE2 <- (alpha * E2 *  p_s * q_s * N_s2 + (A_w * (q_w * N_w2^beta_w2 * E2)^-f_w2 * q_w * N_w2^beta_w2) - c) * dt
  dC_s2 <- (q_s * N_s2 * E2) * dt
  dC_w2 <- (q_w * N_w2^beta_w2 * E2) * dt
  dcpue_s2 <- (C_s2 / E2) * dt
  dcpue_w2 <- (C_w2 / E2) * dt
  ...
  dPi_w2 <- (C_w2 * A_w * (q_w * N_w2^beta_w2 * E2)^-f_w2 - C_w2 * c) * dt
  dPi2 <- (C_s2 * p_s + C_w2 * A_w * (q_w * N_w2^beta_w2 * E2)^-f_w2 - ((C_s2 + C_w2) * c)) * dt
...
```{r scenario 3 pw as a function, echo = FALSE}
# set up the parameter space
beta_w3 <- 0.7
f_w3 <- 0.5
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s3 <- (N_s3 * r_s * (1 - (N_s3/k_s)) - q_s * N_s3 * E3) * dt
  dN_w3 <- (N_w3 * r_w * (1 - (N_w3/k_w)) - q_w * N_w3^beta_w3 * E3) * dt
  dE3 <- (alpha * E3 * p_s * q_s * N_s3 + (A_w * (q_w * N_w3^beta_w3 * E3)^-f_w3 * q_w * N_w3^beta_w3) - c) * dt
  dC_s3 <- (q_s * N_s3 * E3) * dt
  dC_w3 <- (q_w * N_w3^beta_w3 * E3) * dt
  dcpue_s3 <- (C_s3 / E3) * dt
  dcpue_w3 <- (C_w3 / E3) * dt
  ...
  dPi_w3 <- (C_w3 * A_w * (q_w * N_w3^beta_w3 * E3)^-f_w3 - C_w3 * c) * dt
  dPi3 <- (C_s3 * p_s + C_w3 * A_w * (q_w * N_w3^beta_w3 * E3)^-f_w3 - ((C_s3 + C_w3) * c)) * dt
...
```{r scenario 4 pw as a function, echo = FALSE}
# set up the parameter space
beta_w4 <- 0.7
f_w4 <- 0.7
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s4 <- (N_s4 * r_s * (1 - (N_s4/k_s)) - q_s * N_s4 * E4) * dt
  dN_w4 <- (N_w4 * r_w * (1 - (N_w4/k_w)) - q_w * N_w4^beta_w4 * E4) * dt
  dE4 <- (alpha * E4 * p_s * q_s * N_s4 + (A_w * (q_w * N_w4^beta_w4 * E4)^-f_w4 * q_w * N_w4^beta_w4) - c) * dt
  dC_s4 <- (q_s * N_s4 * E4) * dt
  dC_w4 <- (q_w * N_w4^beta_w4 * E4) * dt
  dcpue_s4 <- (C_s4 / E4) * dt
  dcpue_w4 <- (C_w4 / E4) * dt
  ...
  dPi_w4 <- (C_w4 * A_w * (q_w * N_w4^beta_w4 * E4)^-f_w4 - C_w4 * c) * dt
  dPi4 <- (C_s4 * p_s + C_w4 * A_w * (q_w * N_w4^beta_w4 * E4)^-f_w4 - ((C_s4 + C_w4) * c)) * dt
...
```{r scenario 5 pw as a function, echo = FALSE}
# set up the parameter space
beta_w5 <- 0.2
f_w5 <- 0.22
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s5 <- (N_s5 * r_s * (1 - (N_s5/k_s)) - q_s * N_s5 * E5) * dt
  dN_w5 <- (N_w5 * r_w * (1 - (N_w5/k_w)) - q_w * N_w5^beta_w5 * E5) * dt
  dE5 <- (alpha * E5 * p_s * q_s * N_s5 + (A_w * (q_w * N_w5^beta_w5 * E5)^-f_w5 * q_w * N_w5^beta_w5) - c) * dt
  dC_s5 <- (q_s * N_s5 * E5) * dt
  dC_w5 <- (q_w * N_w5^beta_w5 * E5) * dt
  dcpue_s5 <- (C_s5 / E5) * dt
  dcpue_w5 <- (C_w5 / E5) * dt
  ...
  dPi_w5 <- (C_w5 * A_w * (q_w * N_w5^beta_w5 * E5)^-f_w5 - C_w5 * c) * dt
  dPi5 <- (C_s5 * p_s + C_w5 * A_w * (q_w * N_w5^beta_w5 * E5)^-f_w5 - ((C_s5 + C_w5) * c)) * dt
...
```{r scenario 6 pw as a function, echo = FALSE}
# set up the parameter space
beta_w6 <- 0.4
f_w6 <- 0.22
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s6 <- (N_s6 * r_s * (1 - (N_s6/k_s)) - q_s * N_s6 * E6) * dt
  dN_w6 <- (N_w6 * r_w * (1 - (N_w6/k_w)) - q_w * N_w6^beta_w6 * E6) * dt
  dE6 <- (alpha * E6 * p_s * q_s * N_s6 + (A_w * (q_w * N_w6^beta_w6 * E6)^-f_w6 * q_w * N_w6^beta_w6) - c) * dt
  dC_s6 <- (q_s * N_s6 * E6) * dt
  dC_w6 <- (q_w * N_w6^beta_w6 * E6) * dt
  dcpue_s6 <- (C_s6 / E6) * dt
  dcpue_w6 <- (C_w6 / E6) * dt
  ...
  dPi_w6 <- (C_w6 * A_w * (q_w * N_w6^beta_w6 * E6)^-f_w6 - C_w6 * c) * dt
  dPi6 <- (C_s6 * p_s + C_w6 * A_w * (q_w * N_w6^beta_w6 * E6)^-f_w6 - ((C_s6 + C_w6) * c)) * dt
...
```{r scenario 7 pw as a function, echo = FALSE}
# set up the parameter space
beta_w7 <- 0.56
f_w7 <- 0.22
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s7 <- (N_s7 * r_s * (1 - (N_s7/k_s)) - q_s * N_s7 * E7) * dt
  dN_w7 <- (N_w7 * r_w * (1 - (N_w7/k_w)) - q_w * N_w7^beta_w7 * E7) * dt
  dE7 <- (alpha * E7 * p_s * q_s * N_s7 + (A_w * (q_w * N_w7^beta_w7 * E7)^-f_w7 * q_w * N_w7^beta_w7) - c) * dt
  dC_s7 <- (q_s * N_s7 * E7) * dt
  dC_w7 <- (q_w * N_w7^beta_w7 * E7) * dt
  dcpue_s7 <- (C_s7 / E7) * dt
  dcpue_w7 <- (C_w7 / E7) * dt
  ...
  dPi_w7 <- (C_w7 * A_w * (q_w * N_w7^beta_w7 * E7)^-f_w7 - C_w7 * c) * dt
  dPi7 <- (C_s7 * p_s + C_w7 * A_w * (q_w * N_w7^beta_w7 * E7)^-f_w7 - ((C_s7 + C_w7) * c)) * dt
...
```{r scenario 8 pw as a function, echo = FALSE}
# set up the parameter space
beta_w8 <- 0.9
f_w8 <- 0.22
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s8 <- (N_s8 * r_s * (1 - (N_s8/k_s)) - q_s * N_s8 * E8) * dt
  dN_w8 <- (N_w8 * r_w * (1 - (N_w8/k_w)) - q_w * N_w8^beta_w8 * E8) * dt
  dE8 <- (alpha * E8 * p_s * q_s * N_s8 + (A_w * (q_w * N_w8^beta_w8 * E8)^-f_w8 * q_w * N_w8^beta_w8) - c) * dt
  dC_s8 <- (q_s * N_s8 * E8) * dt
  dC_w8 <- (q_w * N_w8^beta_w8 * E8) * dt
  dcpue_s8 <- (C_s8 / E8) * dt
  dcpue_w8 <- (C_w8 / E8) * dt
  ...
  dPi_w8 <- (C_w8 * A_w * (q_w * N_w8^beta_w8 * E8)^-f_w8 - C_w8 * c) * dt
  dPi8 <- (C_s8 * p_s + C_w8 * A_w * (q_w * N_w8^beta_w8 * E8)^-f_w8 - ((C_s8 + C_w8) * c)) * dt
...
```{r, echo = FALSE}
effort_pw_df <- cbind(E_simu1, E_simu2, E_simu3, E_simu4, E_simu5, E_simu6, E_simu7, E_simu8, tset) %>% 
  as.data.frame() %>% 
  pivot_longer(cols = starts_with("E_"),
               names_to = "variable",
               values_to = "value") %>% 
...
nw_pw_df <- cbind(N_w_simu1, N_w_simu2, N_w_simu3, N_w_simu4,N_w_simu5, N_w_simu6, N_w_simu7, N_w_simu8, tset) %>% 
  as.data.frame() %>% 
  pivot_longer(cols = starts_with("N_w_simu"),
               names_to = "variable",
               values_to = "value") %>% 
...
ns_pw_df <- cbind(N_s_simu1,N_s_simu2, N_s_simu3, N_s_simu4, N_s_simu5, N_s_simu6, N_s_simu7, N_s_simu8, tset) %>% 
  as.data.frame() %>% 
  pivot_longer(cols = starts_with("N_s_simu"),
               names_to = "variable",
               values_to = "value") %>% 
...
catch_s_pw_df <- cbind(C_s_simu1,C_s_simu2, C_s_simu3, C_s_simu4, C_s_simu5, C_s_simu6, C_s_simu7, C_s_simu8, tset) %>% 
  as.data.frame() %>% 
  pivot_longer(cols = starts_with("C_s_"),
               names_to = "variable",
               values_to = "value") %>% 
...
catch_w_pw_df <- cbind(C_w_simu1,C_w_simu2, C_w_simu3, C_w_simu4, C_w_simu5, C_w_simu6, C_w_simu7, C_w_simu8, tset) %>% 
  as.data.frame() %>% 
  pivot_longer(cols = starts_with("C_w_"),
               names_to = "variable",
               values_to = "value") %>% 
...
cpue_s_pw_df <- cbind(cpue_s_simu1, cpue_s_simu2, cpue_s_simu3, cpue_s_simu4,  cpue_s_simu5, cpue_s_simu6, cpue_s_simu7, cpue_s_simu8,tset) %>% 
  as.data.frame() %>% 
  pivot_longer(cols = starts_with("cpue_s_"),
               names_to = "variable",
               values_to = "value") %>% 
...
cpue_w_pw_df <- cbind(cpue_w_simu1, cpue_w_simu2, cpue_w_simu3, cpue_w_simu4,cpue_w_simu5, cpue_w_simu6, cpue_w_simu7, cpue_w_simu8, tset) %>% 
  as.data.frame() %>% 
  pivot_longer(cols = starts_with("cpue_w_"),
               names_to = "variable",
               values_to = "value") %>% 
...
profits_pw_df <- cbind(Pi_sum_simu1, Pi_sum_simu2, Pi_sum_simu3, Pi_sum_simu4, Pi_sum_simu5, Pi_sum_simu6, Pi_sum_simu7, Pi_sum_simu8, tset) %>% 
  as.data.frame() %>% 
  pivot_longer(cols = starts_with("Pi_sum"),
               names_to = "variable",
               values_to = "value") %>% 
...
profits_s_pw_df <- cbind(Pi_s_simu1, Pi_s_simu2, Pi_s_simu3, Pi_s_simu4, Pi_s_simu5, Pi_s_simu6, Pi_s_simu7, Pi_s_simu8, tset) %>% 
  as.data.frame() %>% 
  pivot_longer(cols = starts_with("Pi_s_"),
               names_to = "variable",
               values_to = "value") %>% 
...
profits_w_pw_df <- cbind(Pi_w_simu1, Pi_w_simu2, Pi_w_simu3, Pi_w_simu4, Pi_w_simu5, Pi_w_simu6, Pi_w_simu7, Pi_w_simu8, tset) %>% 
  as.data.frame() %>% 
  pivot_longer(cols = starts_with("Pi_w_"),
               names_to = "variable",
               values_to = "value") %>% 
...
var_full_price_pw <- bind_rows(effort_pw_df, nw_pw_df, ns_pw_df, catch_s_pw_df, catch_w_pw_df, cpue_s_pw_df, cpue_w_pw_df, profits_pw_df, profits_w_pw_df, profits_s_pw_df)

# Tidy dataset for plotting

var_plot_price_pw <- var_full_price_pw %>%
   mutate(f_ratio = case_when(
     str_detect(scenario_id, "1") ~ "f_w/f_s = 0.1",
     str_detect(scenario_id, "2") ~ "f_w/f_s = 0.3",
     str_detect(scenario_id, "3") ~ "f_w/f_s = 0.5",
     str_detect(scenario_id, "4") ~ "f_w/f_s = 0.7",
     str_detect(scenario_id, "5") ~ "f_w/f_s = 0.22",
     str_detect(scenario_id, "6") ~ "f_w/f_s = 0.22",
     str_detect(scenario_id, "7") ~ "f_w/f_s = 0.22",
     str_detect(scenario_id, "8") ~ "f_w/f_s = 0.22"
   )) %>% 
   mutate(beta_ratio = case_when(
     str_detect(scenario_id, "1") ~ "beta_w/beta_s = 0.7",
     str_detect(scenario_id, "2") ~ "beta_w/beta_s = 0.7",
     str_detect(scenario_id, "3") ~ "beta_w/beta_s = 0.7",
     str_detect(scenario_id, "4") ~ "beta_w/beta_s = 0.7",
     str_detect(scenario_id, "5") ~ "beta_w/beta_s = 0.2", 
     str_detect(scenario_id, "6") ~ "beta_w/beta_s = 0.4",
     str_detect(scenario_id, "7") ~ "beta_w/beta_s = 0.56",
     str_detect(scenario_id, "8") ~ "beta_w/beta_s = 0.9"
   )) %>% 
  mutate(variable_clean = case_when(
    str_detect(variable, "N_w") ~ "Weak stock",
    str_detect(variable, "N_s") ~ "Strong stock",
...
```{r, echo = FALSE}
f_labels_pw <- c("f = 0.1", "f = 0.3", "f = 0.5", "f = 0.7", "f = 0.22", "f = 0.22", "f = 0.22", "f = 0.22")
names(f_labels_pw) <- c("f_w/f_s = 0.1", "f_w/f_s = 0.3", "f_w/f_s = 0.5", "f_w/f_s = 0.7", "f_w/f_s = 0.22", "f_w/f_s = 0.22", "f_w/f_s = 0.22", "f_w/f_s = 0.22")

beta_labels_pw <- c("beta = 0.7", "beta = 0.7", "beta = 0.7", "beta = 0.7",
                "beta = 0.2", "beta = 0.4", "beta = 0.56", "beta = 0.9")
names(beta_labels_pw) <- c("beta_w/beta_s = 0.7", "beta_w/beta_s = 0.7", "beta_w/beta_s = 0.7", "beta_w/beta_s = 0.7",
                       "beta_w/beta_s = 0.2", "beta_w/beta_s = 0.4", "beta_w/beta_s = 0.56", "beta_w/beta_s = 0.9")


equal_scales_EWS_pw_fcn <-
  var_plot_price_pw %>% 
  filter(variable_clean %in% c("Effort simulation", "Weak stock", "Strong stock")) %>% 
  ggplot() +
  geom_line(aes(x = tset, y = value, color = variable_clean),
            ...
            alpha = .8,
            show.legend = T) +
  facet_wrap(f_ratio ~ beta_ratio,
             nrow = 2,
             labeller = labeller(f_ratio = f_labels_pw,
                                 beta_ratio = beta_labels_pw)) +
