...
output_fcn_test_ps_proc <- output_fcn_test_ps %>% 
  mutate(b_v_k_s = N_s / k_s,
         b_v_k_w = N_w / k_w,
         b_v_k_s2 = N_s2 / k_s,
         b_v_k_w2 = N_w2 / k_w) %>% 
...
for(i in 2:length(tset)) {
 ...
 # }
  ...
  # Calculate change in variable size at each time step
  dN_s1 <- (N_s1 * r_s * (1 - (N_s1/k_s)) - q_s * N_s1^beta_s1 * E1) * dt
  dN_w1 <- (N_w1 * r_w * (1 - (N_w1/k_w)) - q_w * N_w1^beta_w1 * E1) * dt
  dE1 <- (alpha * E1 * (A_s * (q_s * N_s1^beta_s1 * E1)^-f_s1 * q_s * N_s1^beta_s1) + (A_w * (q_w * N_w1^beta_w1 * E1)^-f_w1 * q_w * N_w1^beta_w1) - c) * dt
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s2 <- (N_s2 * r_s * (1 - (N_s2/k_s)) - q_s * N_s2^beta_s2 * E2) * dt
  dN_w2 <- (N_w2 * r_w * (1 - (N_w2/k_w)) - q_w * N_w2^beta_w2 * E2) * dt
  dE2 <- (alpha * E2 * (A_s * (q_s * N_s2^beta_s2 * E2)^-f_s2 * q_s * N_s2^beta_s2) + (A_w * (q_w * N_w2^beta_w2 * E2)^-f_w2 * q_w * N_w2^beta_w2) - c) * dt
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s3 <- (N_s3 * r_s * (1 - (N_s3/k_s)) - q_s * N_s3^beta_s3 * E3) * dt
  dN_w3 <- (N_w3 * r_w * (1 - (N_w3/k_w)) - q_w * N_w3^beta_w3 * E3) * dt
  dE3 <- (alpha * E3 * (A_s * (q_s * N_s3^beta_s3 * E3)^-f_s3 * q_s * N_s3^beta_s3) + (A_w * (q_w * N_w3^beta_w3 * E3)^-f_w3 * q_w * N_w3^beta_w3) - c) * dt
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s4 <- (N_s4 * r_s * (1 - (N_s4/k_s)) - q_s * N_s4^beta_s4 * E4) * dt
  dN_w4 <- (N_w4 * r_w * (1 - (N_w4/k_w)) - q_w * N_w4^beta_w4 * E4) * dt
  dE4 <- (alpha * E4 * (A_s * (q_s * N_s4^beta_s4 * E4)^-f_s4 * q_s * N_s4^beta_s4) + (A_w * (q_w * N_w4^beta_w4 * E4)^-f_w4 * q_w * N_w4^beta_w4) - c) * dt
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s5 <- (N_s5 * r_s * (1 - (N_s5/k_s)) - q_s * N_s5^beta_s5 * E5) * dt
  dN_w5 <- (N_w5 * r_w * (1 - (N_w5/k_w)) - q_w * N_w5^beta_w5 * E5) * dt
  dE5 <- (alpha * E5 * (A_s * (q_s * N_s5^beta_s5 * E5)^-f_s5 * q_s * N_s5^beta_s5) + (A_w * (q_w * N_w5^beta_w5 * E5)^-f_w5 * q_w * N_w5^beta_w5) - c) * dt
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s6 <- (N_s6 * r_s * (1 - (N_s6/k_s)) - q_s * N_s6^beta_s6 * E6) * dt
  dN_w6 <- (N_w6 * r_w * (1 - (N_w6/k_w)) - q_w * N_w6^beta_w6 * E6) * dt
  dE6 <- (alpha * E6 * (A_s * (q_s * N_s6^beta_s6 * E6)^-f_s6 * q_s * N_s6^beta_s6) + (A_w * (q_w * N_w6^beta_w6 * E6)^-f_w6 * q_w * N_w6^beta_w6) - c) * dt
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s7 <- (N_s7 * r_s * (1 - (N_s7/k_s)) - q_s * N_s7^beta_s7 * E7) * dt
  dN_w7 <- (N_w7 * r_w * (1 - (N_w7/k_w)) - q_w * N_w7^beta_w7 * E7) * dt
  dE7 <- (alpha * E7 * (A_s * (q_s * N_s7^beta_s7 * E7)^-f_s7 * q_s * N_s7^beta_s7) + (A_w * (q_w * N_w7^beta_w7 * E7)^-f_w7 * q_w * N_w7^beta_w7) - c) * dt
...
for(i in 2:length(tset)) {
  ...
  # Calculate change in variable size at each time step
  dN_s8 <- (N_s8 * r_s * (1 - (N_s8/k_s)) - q_s * N_s8^beta_s8 * E8) * dt
  dN_w8 <- (N_w8 * r_w * (1 - (N_w8/k_w)) - q_w * N_w8^beta_w8 * E8) * dt
  dE8 <- (alpha * E8 * (A_s * (q_s * N_s8^beta_s8 * E8)^-f_s8 * q_s * N_s8^beta_s8) + (A_w * (q_w * N_w8^beta_w8 * E8)^-f_w8 * q_w * N_w8^beta_w8) - c) * dt
