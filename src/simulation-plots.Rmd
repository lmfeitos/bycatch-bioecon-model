...
sc_1 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = 10, p_w = 1, c = 0.05)
sc_2 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = 5, p_w = 1, c = 0.05)
sc_3 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = 2.5, p_w = 1, c = 0.05)
sc_4 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = 10, p_w = 1, c = 0.05)
sc_5 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = 1, p_w = 1.33, c = 0.05)
sc_6 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = 1, p_w = 2, c = 0.05)
sc_7 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 0.75, r_w = 0.25, p_s = 1, p_w = 4, c = 0.05)
...
equal_scales_EWS <-
  var_plot %>% 
  filter(variable_clean %in% c("Effort", "Weak stock", "Strong stock")) %>% 
  ggplot() +
...
dif_scales <-
  ...
  #             values_from = "value") %>% 
  # rename(weak_stock = "Weak stock",
  #        strong_stock = "Strong stock") %>% 
  # mutate(b_k_w = weak_stock / 2,
  #        b_k_s = strong_stock / 4) %>% 
  # pivot_longer(cols = b_k_w:b_k_s,
  #              names_to = "b_k",
  #              values_to = "b_k_val") %>% 
  # mutate(variable_clean = case_when(
  #   str_detect(variable, "N_w") ~ "Weak stock",
  ...
  facet_wrap(~ factor(price_ratio, 
                      levels = c("PR = 10",
                                 ...
                                 "PR = 0.1")),
             nrow = 1) +
  scale_color_manual(values = c("#D95F02", "#7570B3", "#66A61E", "#E6AB02")) +
