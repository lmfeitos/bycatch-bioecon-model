...
output_fcn_test <- read_csv(file.path(outdir, "output_fcn_tests.csv"))
```
...
s_w_zero_proc_plot <- 
  ggplot() + 
  geom_raster(data = s_w_zero_proc_subset,
              aes(x = growth_ratio, y = p_s, fill = b_v_k)) +
  # geom_line(data = s_w_zero_proc_subset %>% filter(b_v_k <= 0.25),
...
```{r, echo = FALSE}
p_w_labs <- c("pw = 1", "pw = 3", "pw = 5", "pw = 7", "pw = 9", "pw = 11", "pw = 13", "pw = 15")
names(p_w_labs) <- c(1, 3, 5, 7, 9, 11, 13, 15)
...
s_w_range_proc_plot <-
  ...
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.25)) +
  facet_wrap(~ p_w,
             nrow = 1,
             labeller = labeller(p_w = p_w_labs)) +
  scale_x_continuous(breaks = seq(0.1, 1, 0.5),
                     expand = c(0,0)) +
  scale_y_continuous(breaks = seq(0, 10, 1),
                     expand = c(0,0)) +
  labs(x = "Growth rate ratio (rw/rs)",
...
```{r, echo = FALSE}
p_s_labs <- c("ps = 1", "ps = 3", "ps = 5", "ps = 7", "ps = 9", "ps = 11", "ps = 13", "ps = 15")
names(p_s_labs) <- c(1, 3, 5, 7, 9, 11, 13, 15)
...
w_s_range_proc_plot <-
  ...
  scale_x_continuous(breaks = seq(0.1, 1, 0.15),
                      expand = c(0,0)) +
  scale_y_continuous(breaks = seq(0, 10, 1),
                     expand = c(0,0)) +
  labs(x = "Growth rate ratio (rw/rs)",
...
# <- 
  #s_w_zero_proc %>% 
s_w_zero_proc_plot_s <- 
  s_w_zero_proc %>% 
  mutate(growth_ratio = r_w / r_s) %>% 
  filter(variables == "N_s" & b_stocks == "b_values_s" & b_v_k > 0 & b_v_k <= 1) %>% 
  ggplot() + 
  geom_raster(aes(x = growth_ratio, y = p_s, fill = b_v_k)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.5)) +
...
s_w_range_proc_plot_s <-
  ...
  facet_wrap(~ p_w,
             nrow = 1,
             labeller = labeller(p_w = p_w_labs)) +
  scale_x_continuous(breaks = seq(0.1, 1, 0.3),
                     expand = c(0,0)) +
  scale_y_continuous(breaks = seq(0, 10, 1),
                     expand = c(0,0)) +
  labs(x = "Growth rate ratio (rw/rs)",
...
(s_w_zero_proc_plot_s +
  ...
  w_s_range_proc_plot_s) +
  plot_annotation(tag_levels = "A",,
                  title = "Strong stock B/K under different strong and weak stock prices")
```
...
p_w_labs <- c("pw = 0", "pw = 1", "pw = 2", "pw = 3", "pw = 4", "pw = 5", "pw = 6", "pw = 7", "pw = 8")
names(p_w_labs) <- c(0, 1, 2, 3, 4, 5, 6, 7, 8)
...
sc_1 <- run_model(q_s = 0.05, q_w = 0.05, k_s = 4, k_w = 2, r_s = 0.8, r_w = 0.75, p_s = 1, p_w = 0.1, c = 0.05)
sc_2 <- run_model(q_s = 0.05, q_w = 0.05, k_s = 4, k_w = 2, r_s = 0.8, r_w = 0.75, p_s = 1, p_w = 0.2, c = 0.05)
sc_3 <- run_model(q_s = 0.05, q_w = 0.05, k_s = 4, k_w = 2, r_s = 0.8, r_w = 0.75, p_s = 1, p_w = 0.4, c = 0.05)
sc_4 <- run_model(q_s = 0.05, q_w = 0.05, k_s = 4, k_w = 2, r_s = 0.8, r_w = 0.75, p_s = 1, p_w = 1, c = 0.05)
sc_5 <- run_model(q_s = 0.05, q_w = 0.05, k_s = 4, k_w = 2, r_s = 0.8, r_w = 0.75, p_s = 1, p_w = 1.33, c = 0.05)
sc_6 <- run_model(q_s = 0.05, q_w = 0.05, k_s = 4, k_w = 2, r_s = 0.8, r_w = 0.75, p_s = 1, p_w = 12, c = 0.05)
sc_7 <- run_model(q_s = 0.05, q_w = 0.05, k_s = 4, k_w = 2, r_s = 0.8, r_w = 0.75, p_s = 1, p_w = 14, c = 0.05)
sc_8 <- run_model(q_s = 0.05, q_w = 0.05, k_s = 4, k_w = 2, r_s = 0.8, r_w = 0.75, p_s = 1, p_w = 10, c = 0.05)
...
sc_r_1 <- run_model(q_s = 0.05, q_w = 0.05, k_s = 4, k_w = 2, r_s = 1, r_w = 0.7, p_s = 1, p_w = 1, c = 0.05)
...
eq_par <- data.frame(parameter = c("q_w", "q_s", "k_w", "k_s", "r_w", "r_s", "p_w", "p_s", "c"),
                     "RR_2" =    c(0.05, 0.05, 4, 2, 1, 0.7, 1, 1, 0.05),
                     "RR_1.75" = c(0.05, 0.05, 4, 2, 1, 0.88, 1, 1, 0.05),
                     "RR_1.5" =  c(0.05, 0.05, 4, 2, 1, 0.9, 1, 1, 0.05),
                     "RR_1.25" = c(0.05, 0.05, 4, 2, 1, 0.92, 1, 1, 0.05),
                     "RR_1.1" =  c(0.05, 0.05, 4, 2, 1, 0.95, 1, 1, 0.05),
                     "RR_1" =    c(0.05, 0.05, 4, 2, 1, 0.97, 1, 1, 0.05))
...
sc_q_1 <- run_model(q_s = 0.1, q_w = 0.01, k_s = 4, k_w = 2, r_s = 1, r_w = 0.75, p_s = 1, p_w = 1, c = 0.05)
sc_q_2 <- run_model(q_s = 0.1, q_w = 0.02, k_s = 4, k_w = 2, r_s = 1, r_w = 0.75, p_s = 1, p_w = 1, c = 0.05)
sc_q_3 <- run_model(q_s = 0.1, q_w = 0.025, k_s = 4, k_w = 2, r_s = 1, r_w = 0.75, p_s = 1, p_w = 1, c = 0.05)
sc_q_4 <- run_model(q_s = 0.1, q_w = 0.1, k_s = 4, k_w = 2, r_s = 1, r_w = 0.75, p_s = 1, p_w = 1, c = 0.05)
sc_q_5 <- run_model(q_s = 0.1, q_w = 0.133, k_s = 4, k_w = 2, r_s = 1, r_w = 0.75, p_s = 1, p_w = 1, c = 0.05)
sc_q_6 <- run_model(q_s = 0.1, q_w = 0.2, k_s = 4, k_w = 2, r_s = 1, r_w = 0.75, p_s = 1, p_w = 1, c = 0.05)
sc_q_7 <- run_model(q_s = 0.1, q_w = 0.4, k_s = 4, k_w = 2, r_s = 1, r_w = 0.75, p_s = 1, p_w = 1, c = 0.05)
sc_q_8 <- run_model(q_s = 0.1, q_w = 1, k_s = 4, k_w = 2, r_s = 1, r_w = 0.75, p_s = 1, p_w = 1, c = 0.05)
...
eq_q_par <- data.frame(parameter = c("q_w", "q_s", "k_w", "k_s", "r_w", "r_s", "p_w", "p_s", "c"),
                     "QR_10" =  c(0.1, 0.0, 4, 2, 0.8, 0.45, 1, 1, 0.05),
                     "QR_5" =   c(0.1, 0.02, 4, 2, 0.8, 0.45, 1, 1, 0.05),
                     "QR_2.5" = c(0.1, 0.025, 4, 2, 0.8, 0.45, 1, 1, 0.05),
                     "QR_1" =   c(0.1, 0.1, 4, 2, 0.8, 0.45, 1, 1, 0.05),
                     "QR_0.75" =c(0.1, 0.133, 4, 2, 0.8, 0.45, 1, 1, 0.05),
                     "QR_0.5" = c(0.1, 0.2, 4, 2, 0.8, 0.45, 1, 1, 0.05),
                     "QR_0.25" =c(0.1, 0.4, 4, 2, 0.8, 0.45, 1, 1, 0.05),
                     "QR_0.1" = c(0.1, 1, 4, 2, 0.8, 0.45, 1, 1, 0.05))
