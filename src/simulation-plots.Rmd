...
for(i in 2:length(tset)) {
 ...
 # }
  ...
  # set each equation's terms separately
  s1_1 = N_s1 * (r_s * (1 - (N_s1/k_s)))
  s1_2 = q_s * N_s1^beta_s1 * E1
  s2_1 = N_w1 * (r_w * (1 - (N_w1/k_w)))
  s2_2 = q_w * N_w1^beta_w1 * E1
  s3_1 = A_s * ((s1_2)-f_s1 * q_s * N_s1^beta_s1)
  s3_2 = A_w * ((s2_2)-f_w1 * q_w * N_w1^beta_w1)
  ...
  dcpue_s1 <- (C_s1 / E1) * dt
  dcpue_w1 <- (C_w1 / E1) * dt
  dPi_s1 <- ((C_s1 * A_s * (q_s * N_s1^beta_s1 * E1)^-f_s1 * q_s * N_s1^beta_s1) - (C_s1 * c)) * dt
  dPi_w1 <- ((C_w1 * A_w * (q_s * N_w1^beta_w1 * E1)^-f_w1 * q_w * N_w1^beta_w1) - (C_w1 * c)) * dt
...
for(i in 2:length(tset)) {
  ...
  N_w_simu2[i] <- N_w_simu2 + dN_w2
  N_s_simu2[i] <- N_s_simu2 + dN_s2
  E_simu2[i] <- E_simu2 + dE2
  C_s_simu2[i] <- C_s_simu2 + dC_s2
  C_w_simu2[i] <- C_w_simu2 + dC_w2
  cpue_s_simu2[i] <- cpue_s2 + dcpue_s2
  cpue_w_simu2[i] <- cpue_w2 + dcpue_w2
  Pi_sum_simu2[i] <- Pi_sum_simu2 + dPi2
  Pi_s_simu2[i] <- Pi_s_simu2 + dPi_s2
  Pi_w_simu2[i] <- Pi_w_simu2 + dPi_w2  
