...
s_w_range_proc_plot <-
  ggplot() + 
  geom_tile(data = s_w_range_proc %>% filter(p_w == 1),
              aes(x = (q_w/r_w)/ (q_s/r_s), y = st_stock_rev, fill = b_v_k)) +
...
s_w_range_proc_plot2 <-
  ggplot() + 
  geom_tile(data = s_w_range_proc %>% filter(p_w == 1),
              aes(x =  (q_s/r_s)/(q_w/r_w), y = st_stock_rev, fill = b_v_k)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.5)) +
    facet_wrap(~ b_stocks,
               labeller = labeller(b_stocks = b_labs)) +
...
s_w_range_proc_plot3 <-
 ggplot() + 
  geom_tile(data = s_w_range_proc %>% filter(p_s == 1.1),
              aes(x = (q_w/r_w)/ (q_s/r_s), y = w_stock_rev, fill = b_v_k)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.5)) +
    facet_wrap(~ b_stocks,
               labeller = labeller(b_stocks = b_labs)) +
...
s_w_range_proc_plot4 <-
 ggplot() + 
  geom_tile(data = s_w_range_proc %>% filter(p_s == 1.1),
              aes(x = (q_s/r_s)/(q_w/r_w) , y = w_stock_rev, fill = b_v_k)) +
  scale_fill_paletteer_c("viridis::viridis",
                          rescaler = ~ scales::rescale_mid(.x, mid = 0.5)) +
    facet_wrap(~ b_stocks,
               labeller = labeller(b_stocks = b_labs)) +
